...
function Facebook() {
  return (
    <svg className="bg-white rounded-full" width="40" height="40" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
...
function X() {
  return (
    <svg className="bg-white rounded-full" width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0 0 0)">
...
export function Footer() {
  return (
    <>
      <footer id="footer" className="bg-blue-950 md:py-20 md:px-32 flex flex-col md:flex-row md:justify-between flex-wrap">
        ...
        <div className="flex flex-col items-center md:gap-y-6">
            ...
            priority
            />
            <p className="text-gray-300 font-bold md:text-xl text-sm lg:mb-0 ">
                VOTRE PARTENAIRE DE DIGITALISATION
            </p>
        </div>

        <div className="flex flex-col items-center md:flex-row md:justify-between md:gap-x-20">
            <div>
                ...
                <h3 className="font-extrabold text-xl text-white mt-4">
                Ressources
                </h3>
        ...
        <div className="flex flex-col items-center md:flex-row md:justify-between md:gap-x-20">
            <div>
                <h3 className="font-extrabold text-xl text-white mb-5">À propos</h3>
        ...
        <div className="flex flex-col items-center">
            <h3 className="font-extrabold text-xl text-white mb-5">
      ...
      <section className="py-2  border-t-2 border-gray-700 border-dotted">
        <div className="">
          <div className="flex flex-wrap">
            <div className="w-full text-center">
              <p className="text-center text-xl">
                &copy; Tous droit réservés par
                  <span className="font-extrabold"> Interlink </span>
                | <span className="underline font-bold">{new Date().getFullYear()}</span>
              </p>
            </div>
          </div>
        </div>
